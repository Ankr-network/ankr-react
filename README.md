...
## Hooks available
  ...
  * [`useAccountBalance`](#useaccountbalance) — retrieves account balance.
  * [`useBlocks`](#useblocks) — retrieves the block's data.
  * [`useCurrencies`](#usecurrencies) — retrieves the blockchain's currencies.
  * [`useLogs`](#uselogs) — retrieves the block's history data.
  * [`useNFTMetadata`](#usenftmetadata) — retrieves the NFTs metadata.
  * [`useNFTsByOwner`](#usenftsbyowner) — retrieves the account's NFT data.
  * [`useTokenHolders`](#usetokenholders) — retrieves data on token holders.
  * [`useTokenHoldersCount`](#usetokenholderscount) — retrieves the number of token holders.
  * [`useTransactionsByHash`](#usetransactionsbyhash) — retrieves data for the hash-specified transaction.
