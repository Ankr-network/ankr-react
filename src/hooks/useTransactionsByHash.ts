import type { GetTransactionsByHashRequest } from '@ankr.com/ankr.js/dist/types'
...
export const useTransactionsByHash = (params: GetTransactionsByHashRequest) => {
  ...
  const { data, error, isLoading } = useQuery(['getTransactionsByHash', params.transactionHash], () =>
